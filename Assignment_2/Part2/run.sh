...
node0=/users/Kpatil29/Assignment2/Part2/Part2A
node1=/users/Kpatil29/Assignment2/Part2/Part2A
node2=/users/Kpatil29/Assignment2/Part2/Part2A
node3=/users/Kpatil29/Assignment2/Part2/Part2A

## expor path for all nodes for conda path
export_cmd="export PATH=\"/users/Kpatil29/miniconda3/bin:\$PATH\""
